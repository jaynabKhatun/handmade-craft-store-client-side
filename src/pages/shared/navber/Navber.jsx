          ...
          {user ? (
            <div className="flex ">
              <img
                ...
                src={
                  user?.photoURL ||
                  "https://i.ibb.co/wRvJPx7/vecteezy-ai-generated-the-man-said-hi-and-smiled-36110613.jpg"
                }
              />
            ...
            <div className="space-x-4">
              <Link to={"/login"}>
                {" "}
                <button className="btn btn-ghost  bg-gray-300">Sign in</button>
              </Link>
              <Link to={"/register"}>
                {" "}
                <button className="btn btn-ghost bg-gray-300">Sign Up</button>
              </Link>
            </div>
          )}
        </div>
